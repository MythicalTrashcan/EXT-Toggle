...
const myTimeout = setTimeout(openMessage, 250);

function openMessage() {
  self.alert("Hello Michael!  This is the user version of EXT Toggle. To switch to admin, go to the bookmarklet script and change (EXT-User to (EXT-Admin) Admin is only accessable by Mythical Trashcan [The EXT Toggle Owner])")
}
